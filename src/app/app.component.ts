...
import { Firestore, collectionData, collection, setDoc, doc, deleteDoc, deleteField, updateDoc, CollectionReference, DocumentData, FieldPath, Query } from '@angular/fire/firestore';
...
export class AppComponent {
  ...
  addNote(){
    const coll: CollectionReference = collection(this.firestore, 'memos');// collection con firestore holen / Sammlung
